...
public class BookServiceImpl implements BookService {
  ...
  public Iterable<BookDto> findBooksByAuthor(String authorName) {
    ...
    return bookRepository.findAllBooksByAuthors(author).map(b -> modelMapper.map(b, BookDto.class))
  ...
  public Iterable<BookDto> findBooksByPublisher(String publisherName) {
    ...
    return bookRepository.findAllBooksByPublisher(publisher).map(b -> modelMapper.map(b, BookDto.class))
        .collect(Collectors.toList());
  }
  ...
  public AuthorDto removeAuthor(String authorName) {
    Author author = authorRepository.findById(authorName).orElseThrow(EntityNotFoundException::new);
    bookRepository.findAllBooksByAuthors(author)
        .forEach(b -> {
          b.deleteAuthor(author);
